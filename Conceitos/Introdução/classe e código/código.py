...
carro1 = Carro("Laranja", "Mercedes", 2025, "Indisponível") # esses são os atributos do nosso objeto "carro1"
...
carro2 = Carro("Azul escuro", "Ford", 2021, "Disponível") # esses são os atributos do nosso objeto "carro2"
